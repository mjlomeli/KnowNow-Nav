...
import unittest
from Activity.Web.FlaskDriver import *
...
class TestFlaskDriver(unittest.TestCase):
...
def main():
    ...
    import os
    if os.name == 'nt':
        sub.run(['python', '-m', 'unittest', 'Activity/Test/testWeb/testFlaskDriver.py'])
    elif os.name == 'posix':
        sub.run(['python3', '-m', 'unittest', 'Activity/Test/testWeb/testFlaskDriver.py'])
    elif os.name == 'darwin':
        sub.run(['python3', '-m', 'unittest', 'Activity/Test/testWeb/testFlaskDriver.py'])
    else:
